    ...
    return (
        <div className="p-4 bg-white rounded-lg shadow-sm">
            ...
            <div className="flex flex-wrap gap-2 mb-3">
                <button
                    type="button"
                    onClick={() => setPrompt('Make all bullet points more concise without losing key information across all experience sections')}
                    disabled={isLoading}
                ...
                <button
                    type="button"
                    onClick={() => setPrompt('Improve action verbs throughout all professional experience and work experience sections')}
                    disabled={isLoading}
                    className="text-xs px-2 py-1 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-md transition disabled:opacity-50"
                >
                    Better Verbs
                ...
                <button
                    type="button"
                    onClick={() => setPrompt('Rewrite professional summary to be more impactful and enhance all experience descriptions')}
                    disabled={isLoading}
                    className="text-xs px-2 py-1 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-md transition disabled:opacity-50"
                >
                    Improve All
