...
const App: React.FC = () => {
    ...
    const getStepTitle = (step: WorkflowStep): string => {
        switch (step) {
            case 'upload': return '1. Upload & Parse';
            case 'improve': return '2. AI Content Improvement';
            case 'format': return '3. Format & Download';
            default: return '';
        }
    };
                                ...
                                <div key={step} className="flex items-center">
                                    <div className={`flex items-center justify-center w-8 h-8 rounded-full text-sm font-medium ${
                                        currentStep === step 
                                            ...
                                            : resumeData && (step === 'improve' || step === 'format')
                                    ...
                                    {index < 2 && (
                                        <div className={`ml-4 w-8 h-0.5 ${
                                            resumeData && (currentStep === 'improve' || currentStep === 'format') && index === 0
                                                ? 'bg-green-500'
                                                : resumeData && currentStep === 'format' && index === 1
                                                    ? 'bg-green-500'
                                                    : 'bg-gray-300'
                                        }`} />
                                    )}
                ...
                {currentStep === 'improve' && resumeData && (
                    <div className="max-w-4xl mx-auto">
                        <div className="bg-white p-8 rounded-xl shadow-lg">
                            <h2 className="text-2xl font-bold text-gray-800 mb-4">Step 2: Improve Your Content with AI</h2>
                            <p className="text-gray-600 mb-6">Use AI to enhance your resume content before formatting. Try these suggestions:</p>
